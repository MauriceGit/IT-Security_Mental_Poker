...
public class SRAKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair()
    {
        ...
        while (!done)
        {
            ...
            result = new AsymmetricCipherKeyPair(
                new SRAKeyParameters(false, p, q, e),
                //new SRAPrivateCrtKeyParameters(n, e, d, p, q, dP, dQ, qInv));
                new SRAKeyParameters(true, p, q, e));
        }
    ...
    /**
     * Choose a random prime value for use with SRA
     * 
     * @param bitlength the bit-length of the returned prime
     * @param e the SRA public exponent
